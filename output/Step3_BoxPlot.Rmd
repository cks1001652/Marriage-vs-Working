...
```
```{r}
p <- ggplot(FINCP_FES23, aes(x=FES, y=FINCP,fill=FINCP))+geom_boxplot(mapping = NULL, 
     data = NU
     LL, stat = "boxplot", position = "dodge", outlier.colour = "black", 
     outlier.shape = 16, outlier.size = 1.5, notch = FALSE, notchwidth = 0.5)+
     ggtitle("FINCP distribution under FES=2 and FES=3")
...
p <- ggplot(FINCP_FES23, aes(x=FES, y=FINCP,fill=EDU))+geom_boxplot(mapping = NULL, 
     ...
     outlier.shape = 16, outlier.size = 1.5, notch = FALSE, notchwidth = 0.5)+
     ggtitle("FINCP distribution in terms of education under FES=2 and FES=3")
...
p <- ggplot(FINCP_FES23, aes(x=FES, y=FINCP,fill=INDP))+geom_boxplot(mapping = NULL, 
     data = NULL, stat = "boxplot", position = "dodge", outlier.colour = "black", 
     outlier.shape = 16, outlier.size = 1.5, notch = FALSE, notchwidth = 0.5)+
