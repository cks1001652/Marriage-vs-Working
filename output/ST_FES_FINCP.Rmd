...
````{r}
options(scipen = 3) # display digits instead of scientific notation
ggplot(fesnumbers, aes(x= Types , y=fesnumbers$count, fill=Types)) +                        
     ...
     ggtitle("Labor Force Participation of Married Families in the US") +
     theme(axis.text.x = element_text(angle = 8, hjust = 0.5),
     panel.background = element_rect(fill = 'white')) +
     scale_y_discrete(breaks = seq(0, 300000, 50000))
````
